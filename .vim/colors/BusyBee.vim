...
hi Normal 		   guifg=#e2e2e5 guibg=#202020 gui=none ctermfg=253
hi NonText 		   guifg=#808080 guibg=#202020 gui=none ctermfg=244
hi LineNr 		   guifg=#303030 guibg=#202020 gui=none ctermfg=244
...
" TabLine
hi TabLine         term=underline cterm=underline ctermfg=15 ctermbg=NONE gui=underline guibg=NONE
hi TabLineSel      term=bold,underline cterm=bold,underline ctermfg=15 gui=bold,underline
hi TabLineFill     term=underline cterm=underline ctermfg=15 gui=underline
